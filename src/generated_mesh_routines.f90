...
MODULE GENERATED_MESH_ROUTINES
  ...
  INTEGER(INTG), PARAMETER :: GENERATED_MESH_REGULAR_FRACTAL_TREE_MESH_TYPE=3 !<A regular fractal tree generated mesh. \see GENERATED_MESH_ROUTINES_GeneratedMeshTypes,GENERATED_MESH_ROUTINES
  INTEGER(INTG), PARAMETER :: GENERATED_MESH_STOCHASTIC_FRACTAL_TREE_MESH_TYPE=4 !<A stochastic fractal tree generated mesh. \see GENERATED_MESH_ROUTINES_GeneratedMeshTypes,GENERATED_MESH_ROUTINES
  INTEGER(INTG), PARAMETER :: GENERATED_MESH_CYLINDER_MESH_TYPE=5 !<A cylinder generated mesh. \see GENERATED_MESH_ROUTINES_GeneratedMeshTypes,GENERATED_MESH_ROUTINES
  INTEGER(INTG), PARAMETER :: GENERATED_MESH_ELLIPSOID_MESH_TYPE=6 !<An ellipsoid generated mesh. \see GENERATED_MESH_ROUTINES_GeneratedMeshTypes,GENERATED_MESH_ROUTINES
  !>@}
  ...
  PUBLIC GENERATED_MESH_REGULAR_FRACTAL_TREE_MESH_TYPE,GENERATED_MESH_STOCHASTIC_FRACTAL_TREE_MESH_TYPE
  PUBLIC GENERATED_MESH_CYLINDER_MESH_TYPE
...
999 CALL ERRORS("GENERATED_MESH_FINALISE",ERR,ERROR)
  ...
  SUBROUTINE GENERATED_MESH_INITIALISE(GENERATED_MESH,ERR,ERROR,*)
    ...
    ELSE
      ...
      NULLIFY(GENERATED_MESH%stochasticTreeMesh)
...
998 CALL ERRORS("GENERATED_MESH_REGULAR_INITIALISE",ERR,ERROR)
  ...
  !>Finalise the stochastic fractal tree mesh type
  SUBROUTINE GeneratedMesh_StochasticTreeFinalise(stochasticTreeMesh,err,error,*)

    !Argument variables
    TYPE(GeneratedMesh_StochasticTreeType), POINTER :: stochasticTreeMesh !<A pointer to the stochastic tree mesh to finalise
    INTEGER(INTG), INTENT(OUT) :: err !<The error code
    TYPE(VARYING_STRING), INTENT(OUT) :: error !<The error string
    !Local Variables

    CALL Enters("GeneratedMesh_StochasticTreeFinalise",err,error,*999)

    IF(ASSOCIATED(stochasticTreeMesh)) THEN
      DEALLOCATE(stochasticTreeMesh)
    ENDIF

    CALL Exits("GeneratedMesh_StochasticTreeFinalise")
    RETURN
999 CALL Errors("GeneratedMesh_StochasticTreeFinalise",err,error)
    CALL Exits("GeneratedMesh_StochasticTreeFinalise")
    RETURN 1
  END SUBROUTINE GeneratedMesh_StochasticTreeFinalise

  !
  !================================================================================================================================
  !

  !>Initialise the stochastic fractal tree generated mesh type
  SUBROUTINE GeneratedMesh_StochasticTreeInitialise(generatedMesh,err,error,*)

    !Argument variables
    TYPE(GENERATED_MESH_TYPE), POINTER :: generatedMesh !<A pointer to the generated mesh to initialise the stochastic tree mesh for
    INTEGER(INTG), INTENT(OUT) :: err !<The error code
    TYPE(VARYING_STRING), INTENT(OUT) :: error !<The error string
    !Local Variables
