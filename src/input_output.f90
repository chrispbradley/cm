...
MODULE INPUT_OUTPUT
  ...
  PUBLIC WriteString,WriteStringValue,WriteStringTwoValue,WriteStringFmtValue,WriteStringFmtTwoValue, &
    & WriteStringVector,WriteStringIdxVector,WriteStringMatrix
