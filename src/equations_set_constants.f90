...
MODULE EQUATIONS_SET_CONSTANTS
 ...
 !Bioelectrics class
  ...
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_INCOMPRESSIBLE_MOONEY_RIVLIN_SUBTYPE=19
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_TRANSVERSE_ISOTROPIC_POLYNOMIAL_SUBTYPE=20
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_NEARLY_INCOMPRESSIBLE_MOONEY_RIVLIN_SUBTYPE=21
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_TRANSVERSE_ISOTROPIC_HUMPHREY_YIN_SUBTYPE=22
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_MOONEY_RIVLIN_ACTIVECONTRACTION_SUBTYPE=23
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_STVENANT_KIRCHOFF_ACTIVECONTRACTION_SUBTYPE=24
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_COMPRESSIBLE_ACTIVECONTRACTION_SUBTYPE=25
