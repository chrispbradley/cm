...
#include "include/petscversion.h"
  ...
  PUBLIC SOLVER_EQUATIONS_EQUATIONS_SET_FIELD_VARIABLE_FIX

  PUBLIC SOLVER_EQUATIONS_INTERFACE_CONDITION_ADD

  PUBLIC SOLVER_EQUATIONS_INTERFACE_CONDITION_FIELD_VARIABLE_FIX
